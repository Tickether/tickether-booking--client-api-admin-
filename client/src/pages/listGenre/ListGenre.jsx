...
const ListGenre= () => {
    ...
    const {data, loading, reFetch} = useFetch(`http://tickether-env.eba-38hrijp2.ap-northeast-1.elasticbeanstalk.com/api/bookees?genre=${genre}&min=${min || 0}&max=${max || 10000000}`)
